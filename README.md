...
- [Terraform: Serverless Kubernetes Cluster with AWS EKS](https://levelup.gitconnected.com/serverless-webhosting-with-aws-eks-on-fargate-using-terraform-fcd1d98170c1)
- [Automating Hadoop Cluster Deployment on AWS using Ansible](https://blog.devgenius.io/automate-hadoop-cluster-deployment-on-top-of-aws-using-ansible-194b623b9103)
<!-- BLOG-POST-LIST:END -->
